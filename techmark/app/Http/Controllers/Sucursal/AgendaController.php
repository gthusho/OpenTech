...
class AgendaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if(Auth::user()->can('allow-read')){
            $this->datos['brand'] = Tool::brand('Actividades Agendadas',route('agenda.index'),'Agenda ');
            $this->datos['actividades'] =  Agenda::name($request->get('s'))->usuario(Auth::user()->id)
                ->orderBy('id','desc')->paginate();
            return view('cpanel.sucursal.agenda.list',$this->datos);
        }
    ...
    public function create()
    {
        if(Auth::user()->can('allow-insert')){
            $this->datos['brand'] = Tool::brand('Registrar Actividad',route('agenda.index'),'Agenda  ');
            return view('cpanel.sucursal.agenda.registro',$this->datos);
        }
    ...
    public function edit($id)
    {
        if(Auth::user()->can('allow-edit')){
            $this->datos['brand'] = Tool::brand('Editar Actividad',route('agenda.index'),'Agenda  ');
            $this->datos['actividad'] = Agenda::find($id);
            return view('cpanel.sucursal.agenda.edit',$this->datos);
        }
