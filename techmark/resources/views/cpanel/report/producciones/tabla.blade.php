        ...
        @foreach($producciones as $row)
            <tr >
                ...
                <td  style="border-bottom: 1px dashed black;">
                    ...
                    @elseif($row->checkState()[1]=='t' && $row->terminado==1) <b>En Inventario</b>
                ...
                <td style="border-bottom: 1px dashed black;"><b>Responsable: </b>{{$row->trabajador->nombre}} <br>{{$row->destino}} </td>
