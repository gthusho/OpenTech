        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.proveedor.destroy',$proveedor->IdProveedor],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($proveedor,['route'=>['admin.proveedor.update',$proveedor->IdProveedor],'method'=>'PUT','files'=>true,'id'=>'form-proveedor']) !!}
