        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.stock.destroy',$haber->IdExistencia],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($haber,['route'=>['admin.stock.update',$haber->IdExistencia],'method'=>'PUT','files'=>true,'id'=>'form-stock']) !!}
