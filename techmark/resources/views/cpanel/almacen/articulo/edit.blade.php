        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.articulo.destroy',$articulo->IdArticulo],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($articulo,['route'=>['admin.articulo.update',$articulo->IdArticulo],'method'=>'PUT','files'=>true,'id'=>'form-articulo']) !!}
