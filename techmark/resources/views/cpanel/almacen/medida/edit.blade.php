        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.medida.destroy',$medida->IdMedida],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($medida,['route'=>['admin.medida.update',$medida->IdMedida],'method'=>'PUT','files'=>true,'id'=>'form-medida']) !!}
