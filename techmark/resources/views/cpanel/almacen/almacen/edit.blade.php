        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.almacen.destroy',$almacen->IdAlmacen],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($almacen,['route'=>['admin.almacen.update',$almacen->IdAlmacen],'method'=>'PUT','files'=>true,'id'=>'form-almacen']) !!}
