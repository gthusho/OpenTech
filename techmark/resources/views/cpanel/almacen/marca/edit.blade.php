        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.marca.destroy',$marca->IdMarca],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($marca,['route'=>['admin.marca.update',$marca->IdMarca],'method'=>'PUT','files'=>true,'id'=>'form-marca']) !!}
