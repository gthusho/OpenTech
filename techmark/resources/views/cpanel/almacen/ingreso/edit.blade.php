        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.ingreso.destroy',$ingreso->IdIngreso],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($ingreso,['route'=>['admin.ingreso.update',$ingreso->IdIngreso],'method'=>'PUT','files'=>true,'id'=>'form-ingreso']) !!}
