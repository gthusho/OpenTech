        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="pull-right">
                    {!! Form::open(['route'=>['admin.egreso.destroy',$egreso->IdEgreso],'method'=>'delete','id'=>'form-delete']) !!}
                ...
                {!! Form::model($egreso,['route'=>['admin.egreso.update',$egreso->IdEgreso],'method'=>'PUT','files'=>true,'id'=>'form-egreso']) !!}
