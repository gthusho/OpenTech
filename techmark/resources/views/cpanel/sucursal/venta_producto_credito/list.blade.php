...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            @include('cpanel.sucursal.venta_producto_credito.partials.report')
    ...
    <div class="row">
      <div class="col-sm-12">
          @include('cpanel.sucursal.venta_producto_credito.partials.search')
      </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <div class="table-rep-plugin">
                    <div class="table-responsive" data-pattern="priority-columns">
                       ...
                       @include('cpanel.sucursal.venta_producto_credito.partials.tablelist')
