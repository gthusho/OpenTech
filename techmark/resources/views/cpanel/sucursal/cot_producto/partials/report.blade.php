...
<div class="btn-group pull-right m-t-15">
    <a href="{{url('reportes/cotizaciones/productos').\App\Tool::getDataReportQuery(true,Auth::user()->id)}}" class="btn btn-inverse  waves-effect waves-light" target="_blank" >Imprimir <span class="m-l-5"><i class=" icon-printer"></i></span></a>
</div>
