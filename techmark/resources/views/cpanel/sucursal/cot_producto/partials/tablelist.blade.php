            ...
            <tbody>
                @foreach($cotizaciones as $row)
                    ...
                    <tr >
                        ...
                        <td>
                            <a href="{{route('s.cot_producto.edit',$row->id)}}" class="btn btn-primary btn-sm"> <i class="icon-pencil fa-2x"></i> </a>
                        </td>
                        <td>
                            <button onclick="printJS('{{url('reportes/cotizacion/producto').'?id='.$row->id}}')"
                               class="btn btn-primary btn-sm"> <i class=" icon-printer fa-2x"></i> </button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
