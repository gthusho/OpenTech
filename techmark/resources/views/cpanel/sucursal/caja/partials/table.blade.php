    ...
    @foreach($cajas as $row)
        <tr>
            ...
            <td class="text-center">
                <a href="{{route('cajavistas.edit',$row->id)}}" class="btn btn-success btn-sm"> <i class=" icon-eye fa-2x"></i>  </a>
            </td>
            @if ($row->estado != 't')
            <td class="text-center">
                <a href="{{route('caja.show',$row->id)}}" class="btn btn-danger btn-sm"> <i class=" icon-wallet fa-2x"></i>  </a>
