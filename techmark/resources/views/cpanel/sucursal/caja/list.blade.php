...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            @include('cpanel.sucursal.caja.partials.report')
    ...
    <div class="row">
      <div class="col-sm-12">
          @include('cpanel.sucursal.caja.partials.search')
      </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <div class="table-rep-plugin">
                    <div class="table-responsive" data-pattern="priority-columns">
                        @include('cpanel.sucursal.caja.partials.table')
                    </div>
    ...
    <div class="col-lg-12">
        <div class="pull-left">
            {{$cajas->appends(Request::only(['s']))->render()}}
        </div>
    </div>
@endsection
@section('css')
