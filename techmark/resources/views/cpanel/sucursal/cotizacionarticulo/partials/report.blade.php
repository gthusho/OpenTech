...
<div class="btn-group pull-right m-t-15">
    <button onclick="printJS('{{url('reportes/cotizaciones/articulos').\App\Tool::getDataReportQuery(true,Auth::user()->id)}}')" class="btn btn-inverse  waves-effect waves-light" target="_blank" >Imprimir <span class="m-l-5"><i class=" icon-printer"></i></span></button>
</div>
