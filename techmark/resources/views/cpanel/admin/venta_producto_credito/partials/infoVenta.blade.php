...
<div class="panel panel-border panel-custom">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input name="abono" type="text" class="form-control cleanclean" autocomplete="off" id="abono" data-parsley-min="0" data-parsley-max="{{$venta->getTotalDeuda()}}" required onkeypress="return isNumberKey(event)">
        </div>
        <div class="form-group">
            {!! Form::label('Saldo  ')!!}
