                ...
                @foreach($ventas as $row)
                    <tr >
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{route('admin.venta-credito-art.show',$row->id)}}" class="btn btn-primary btn-sm"> <i class="fa  fa-money fa-2x"></i></a>
                            @endif
                        </td>
                        <td class="text-center">
                            <button onclick="printJS('{{url('reportes/pagos/venta').'?id='.$row->id}}')" class="btn btn-primary btn-sm"> <i class=" icon-printer fa-2x"></i> </button>
                        </td>
