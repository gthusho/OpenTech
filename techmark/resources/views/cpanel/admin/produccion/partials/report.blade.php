...
<div class="btn-group pull-right m-t-15">
    <a href="{{url('reportes/producciones').\App\Tool::getDataReportQuery()}}" class="btn btn-inverse  waves-effect waves-light" target="_blank" >Imprimir <span class="m-l-5"><i class=" icon-printer"></i></span></a>
</div>
