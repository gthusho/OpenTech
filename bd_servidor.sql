CREATE DATABASE  IF NOT EXISTS `texmarck_jade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `texmarck_jade`;
-- MySQL dump 10.13  Distrib 5.6.19, for Win32 (x86)
--
-- Host: 107.190.132.210    Database: texmarck_jade
-- ------------------------------------------------------
...
-- Dump completed on 2018-01-03 10:36:13
